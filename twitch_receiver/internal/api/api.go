...
func getAuthKey(dbServices *service.ReceiverService) string {
...
func generateNewAuthKey(dbServices *service.ReceiverService) (*clientCredentials, error) {
...
func CallApi(dbServices *service.ReceiverService, method string, endpoint string, data string, parameters *url.Values) (int, []byte, error) {
	...
	if response.StatusCode == http.StatusTooManyRequests {
		...
		if response.StatusCode != http.StatusConflict && (response.StatusCode >= 300 || response.StatusCode < 200) {
...
func DeleteSubscription(dbServices *service.ReceiverService, id string) (int, []byte, error) {
	parameters := &url.Values{}
